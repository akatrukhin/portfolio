...
<section
	class="relative rounded h-svh sm:-mt-[107px] sm:pt-[107px] flex items-center justify-center"
>
	<div class="flex flex-col pb-[10vh] sm:pr-[10vw] sm:pb-[15vh]">
		<h1
			class="lg:text-4xl md:text-3xl text-2xl px-7 tracking-tight leading-10 relative"
		>
			<span class="sm:hidden relative z-10"
				>Hi there 👋🏻! I'm Alexander, a
			</span>
			<span class="hidden sm:block font-black relative z-10">
				Hello, I'm a Front-End Developer
			</span>
			<span class="sm:hidden font-black">Front-End Developer <br /></span>
	...
	<div
		class="absolute flex items-center bottom-7 left-7 right-7 transition-all gap-12 duration-400 transform {scrollY >
		50
